...
def daily_search(stock, n, index_name):
    n += 1
    #   time.sleep(1)
    ...
    try:
        ...
        return (condition_1 and condition_2 and condition_3 and condition_4 and condition_5 and
                condition_6 and condition_7 and condition_8), 'Daily'
